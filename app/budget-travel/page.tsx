      ...
      <section className="px-6 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
            Budget Travel by{' '}
            <span className="text-skyblue">Region</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {regionStats.map((stat, i) => (
            <Link
              ...
              className="group bg-white/[0.04] border border-white/10 hover:border-skyblue/40 rounded-2xl p-6 transition-all hover:bg-white/[0.06]"
            >
              ...
              <h2 className="text-2xl font-bold text-white group-hover:text-skyblue transition mb-3">
                {stat.region}
              </h2>
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <p className="text-white/40 text-xs">Cheapest</p>
                  <p className="text-skyblue font-bold text-xl">${stat.cheapest}/day</p>
              ...
              <p className="text-skyblue text-sm group-hover:underline">
