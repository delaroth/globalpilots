...
const destinations: DestinationCost[] = [
  ...
  // ========== AFRICA (additional) ==========
  {
    ...
    dailyCosts: {
      budget: { hotel: 30, food: 15, transport: 8, activities: 10 },
      mid: { hotel: 80, food: 35, transport: 15, activities: 25 },
      comfort: { hotel: 200, food: 70, transport: 30, activities: 50 },
    },
    currency: 'MUR',
    bestMonths: [5, 6, 7, 8, 9, 10, 11],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Stay in guesthouses rather than resorts — $25-40/night vs $200+',
      'Eat at local dhaba-style eateries for $3-5 per meal',
      'Take public buses which are very cheap at $0.50-1 per ride',
      'Visit free public beaches like Flic en Flac and Mont Choisy',
    ],
  },
  ...
  // ========== SOUTH AMERICA (additional) ==========
  {
    ...
    dailyCosts: {
      budget: { hotel: 18, food: 12, transport: 5, activities: 8 },
      mid: { hotel: 60, food: 30, transport: 12, activities: 20 },
      comfort: { hotel: 150, food: 60, transport: 25, activities: 45 },
    },
    currency: 'BRL',
    bestMonths: [3, 4, 5, 9, 10, 11],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Eat at per-kilo buffet restaurants for $3-6 per meal',
      'Use the metro and VLT tram — much cheaper than taxis',
      'Visit Sugarloaf and Christ the Redeemer early to avoid peak pricing',
      'Stay in Santa Teresa or Lapa for cheaper hostels near the action',
    ],
  },
  {
    code: 'CUZ',
    ...
    region: 'South America',
    dailyCosts: {
      budget: { hotel: 10, food: 6, transport: 3, activities: 10 },
      mid: { hotel: 40, food: 18, transport: 8, activities: 25 },
      comfort: { hotel: 100, food: 40, transport: 15, activities: 50 },
    },
    currency: 'PEN',
    bestMonths: [4, 5, 6, 7, 8, 9, 10],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Eat set lunch menus (menu del dia) for $1.50-3 at local restaurants',
      'Buy the Boleto Turistico for $18 — covers 16 archaeological sites',
      'Take colectivos (shared vans) instead of tourist shuttles',
      'Book Machu Picchu tickets well in advance to get the cheapest slots',
    ],
  },
  {
    code: 'CTG',
    ...
    region: 'South America',
    dailyCosts: {
      budget: { hotel: 12, food: 8, transport: 3, activities: 8 },
      mid: { hotel: 50, food: 22, transport: 8, activities: 18 },
      comfort: { hotel: 130, food: 50, transport: 15, activities: 40 },
    },
    currency: 'COP',
    bestMonths: [12, 1, 2, 3, 4],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Stay in Getsemani neighborhood — way cheaper than the walled city',
      'Eat set meals at corrientazos (local lunch spots) for $2-3',
      'Walk the walled city and street art for free',
      'Take public boats to Playa Blanca instead of tourist boat tours',
    ],
  },
  {
    code: 'FLN',
    ...
    region: 'South America',
    dailyCosts: {
      budget: { hotel: 15, food: 10, transport: 5, activities: 5 },
      mid: { hotel: 50, food: 25, transport: 12, activities: 15 },
      comfort: { hotel: 120, food: 50, transport: 20, activities: 35 },
    },
    currency: 'BRL',
    bestMonths: [12, 1, 2, 3, 11],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Visit off-season (April-October) for drastically lower accommodation prices',
      'Eat at per-kilo restaurants for $3-5 per filling meal',
      'Take local buses to beaches — much cheaper than renting a car',
      'Explore the free Lagoa da Conceicao area for hiking and sunset views',
    ],
  },
  ...
  // ========== CENTRAL ASIA (additional) ==========
  {
    ...
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Eat khinkali dumplings at local spots — 5 dumplings for $1-2',
      'Walk the Old Town, Narikala Fortress, and Bridge of Peace for free',
      'Take marshrutkas (minibuses) for $0.20-0.30 per ride',
      'Try local wine at family-run marani (wine cellars) for cheap tastings',
    ],
  },
  {
    code: 'BHK',
    ...
    dailyCosts: {
      budget: { hotel: 8, food: 4, transport: 2, activities: 3 },
      mid: { hotel: 30, food: 12, transport: 5, activities: 8 },
      comfort: { hotel: 70, food: 25, transport: 10, activities: 20 },
    },
    currency: 'UZS',
    bestMonths: [3, 4, 5, 9, 10, 11],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Stay in traditional guesthouses in the old city for $8-15/night',
      'Eat plov, shashlik, and somsa at local chaikhanas for $1-3',
      'Walk the compact old city — all major sights are within a 20-minute radius',
      'Visit mosques and madrasas with a combined ticket for better value',
    ],
  },
  {
    code: 'SKD',
    ...
    dailyCosts: {
      budget: { hotel: 8, food: 4, transport: 2, activities: 4 },
      mid: { hotel: 30, food: 12, transport: 5, activities: 10 },
      comfort: { hotel: 75, food: 28, transport: 10, activities: 22 },
    },
    currency: 'UZS',
    bestMonths: [3, 4, 5, 9, 10, 11],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Buy a combined ticket for Registan, Shah-i-Zinda, and other sites',
      'Eat at local restaurants near Siab Bazaar for $1-3 meals',
      'Take shared taxis between cities — Samarkand to Bukhara for $5-8',
      'Stay in B&Bs run by Uzbek families for authentic experience and low prices',
    ],
  },
  {
    code: 'DYU',
    ...
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Eat qurutob and plov at local chaikhanas for $1-2',
      'Visit the National Museum and Rudaki Park for free or minimal cost',
      'Take marshrutkas around town for $0.15 per ride',
      'Use Dushanbe as a base for cheap day trips to Varzob Valley',
    ],
  },
  ...
  // ========== PACIFIC ISLANDS ==========
  {
    ...
    dailyCosts: {
      budget: { hotel: 25, food: 15, transport: 8, activities: 12 },
      mid: { hotel: 80, food: 35, transport: 15, activities: 30 },
      comfort: { hotel: 200, food: 65, transport: 25, activities: 55 },
    },
    currency: 'FJD',
    bestMonths: [5, 6, 7, 8, 9, 10],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR', 'NZ'],
    savingTips: [
      'Stay in dorm-style beach bures on the Yasawa or Mamanuca islands',
      'Eat at local Fijian restaurants for $4-7 instead of resort dining',
      'Take the Yasawa Flyer ferry instead of expensive seaplane transfers',
      'Snorkel from the beach for free — many reefs are right offshore',
    ],
  },
  {
    code: 'PPT',
    ...
    region: 'Pacific Islands',
    dailyCosts: {
      budget: { hotel: 40, food: 25, transport: 10, activities: 15 },
      mid: { hotel: 120, food: 50, transport: 20, activities: 40 },
      comfort: { hotel: 300, food: 90, transport: 35, activities: 70 },
    },
    currency: 'XPF',
    bestMonths: [5, 6, 7, 8, 9, 10],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP'],
    savingTips: [
      'Eat at les roulottes (food trucks) at the Papeete waterfront for $8-12',
      'Stay in pensions (guesthouses) on Moorea instead of Bora Bora resorts',
      'Take the public ferry to Moorea for $12 instead of a flight',
      'Visit free public beaches and hike to Belvedere Lookout at no cost',
    ],
  },
  {
    code: 'APW',
    ...
    region: 'Pacific Islands',
    dailyCosts: {
      budget: { hotel: 20, food: 12, transport: 5, activities: 8 },
      mid: { hotel: 65, food: 28, transport: 12, activities: 20 },
      comfort: { hotel: 150, food: 55, transport: 20, activities: 40 },
    },
    currency: 'WST',
    bestMonths: [5, 6, 7, 8, 9, 10],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'NZ'],
    savingTips: [
      'Stay in beach fales (open-air huts) for $15-25/night including meals',
      'Take local buses around Upolu for $1-2 per ride',
      'Swim at To Sua Ocean Trench and natural beaches for minimal entry fees',
      'Eat at local markets — fresh fish and taro dishes for $3-5',
    ],
  },
  {
    code: 'TBU',
    ...
    region: 'Pacific Islands',
    dailyCosts: {
      budget: { hotel: 22, food: 12, transport: 6, activities: 8 },
      mid: { hotel: 70, food: 30, transport: 12, activities: 22 },
      comfort: { hotel: 160, food: 55, transport: 22, activities: 45 },
    },
    currency: 'TOP',
    bestMonths: [5, 6, 7, 8, 9, 10, 11],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'NZ'],
    savingTips: [
      'Stay at locally owned guesthouses for $20-35/night',
      'Eat at local eateries and markets for $4-6 per meal',
      'Visit the blowholes, trilithon, and royal tombs for free or minimal cost',
      'Go whale watching in season (Jul-Oct) with a local operator for best prices',
    ],
  },
  {
    code: 'VLI',
    ...
    region: 'Pacific Islands',
    dailyCosts: {
      budget: { hotel: 25, food: 14, transport: 6, activities: 10 },
      mid: { hotel: 75, food: 32, transport: 14, activities: 25 },
      comfort: { hotel: 180, food: 60, transport: 25, activities: 50 },
    },
    currency: 'VUV',
    bestMonths: [4, 5, 6, 7, 8, 9, 10],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'NZ'],
    savingTips: [
      'Stay in locally run bungalows rather than international resorts',
      'Eat at the Port Vila market for cheap fresh fruit and local dishes',
      'Take minibuses around town for $1 per ride',
      'Snorkel from public beaches and visit free cultural villages on outer islands',
    ],
  },
  ...
  // ========== EUROPE (additional) ==========
  {
    ...
    region: 'Europe',
    dailyCosts: {
      budget: { hotel: 18, food: 12, transport: 4, activities: 6 },
      mid: { hotel: 55, food: 25, transport: 8, activities: 15 },
      comfort: { hotel: 120, food: 50, transport: 15, activities: 30 },
    },
    currency: 'EUR',
    bestMonths: [4, 5, 6, 9, 10],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Walk the Upper Town and Dolac Market for free',
      'Use the tram system for $1.50 per ride — covers the whole city',
      'Eat at local konobas (taverns) for $5-8 per meal',
      'Visit the free Museum of Broken Relationships on discount days',
    ],
  },
  {
    code: 'LJU',
    ...
    region: 'Europe',
    dailyCosts: {
      budget: { hotel: 20, food: 12, transport: 4, activities: 6 },
      mid: { hotel: 60, food: 28, transport: 8, activities: 15 },
      comfort: { hotel: 130, food: 55, transport: 15, activities: 30 },
    },
    currency: 'EUR',
    bestMonths: [5, 6, 7, 8, 9],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Walk the compact car-free old town and Triple Bridge area for free',
      'Take a day trip to Lake Bled by bus for $7 round trip',
      'Eat burek and local lunches for $4-7 at small eateries',
      'Use the Ljubljana Urban Card for free bus rides and museum discounts',
    ],
  },
  {
    code: 'DBV',
    ...
    region: 'Europe',
    dailyCosts: {
      budget: { hotel: 25, food: 15, transport: 5, activities: 12 },
      mid: { hotel: 80, food: 35, transport: 10, activities: 25 },
      comfort: { hotel: 200, food: 65, transport: 20, activities: 50 },
    },
    currency: 'EUR',
    bestMonths: [5, 6, 9, 10],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Visit in shoulder season (May or October) for 40-50% lower hotel prices',
      'Eat outside the walled city for significantly cheaper meals',
      'Walk the city walls early morning for the best experience ($30 entry)',
      'Take the local ferry to Lokrum Island instead of expensive boat tours',
    ],
  },
  {
    code: 'OPO',
    ...
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Eat francesinha sandwiches at local spots for $5-8',
      'Walk across the Dom Luis I Bridge and explore Ribeira for free',
      'Try port wine tastings in Vila Nova de Gaia — some cellars offer free samples',
      'Use the Andante card for cheaper metro and bus rides',
    ],
  },
  {
    code: 'GDN',
    ...
    region: 'Europe',
    dailyCosts: {
      budget: { hotel: 14, food: 8, transport: 3, activities: 5 },
      mid: { hotel: 45, food: 20, transport: 6, activities: 12 },
      comfort: { hotel: 100, food: 40, transport: 12, activities: 25 },
    },
    currency: 'PLN',
    bestMonths: [5, 6, 7, 8, 9],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Walk the beautifully rebuilt Long Market and waterfront for free',
      'Eat pierogi and zurek at milk bars (bar mleczny) for $2-4',
      'Take the commuter train to Sopot beach for $1.50',
      'Visit the European Solidarity Centre and WWII Museum on free entry days',
    ],
  },
  {
    code: 'BRN',
    ...
    region: 'Europe',
    dailyCosts: {
      budget: { hotel: 45, food: 30, transport: 10, activities: 10 },
      mid: { hotel: 120, food: 55, transport: 18, activities: 25 },
      comfort: { hotel: 250, food: 100, transport: 30, activities: 50 },
    },
    currency: 'CHF',
    bestMonths: [5, 6, 7, 8, 9],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Buy groceries at Migros or Coop instead of eating out',
      'Walk the UNESCO old town, Zytglogge, and Bear Park for free',
      'Get a Swiss Half Fare Card if traveling beyond Bern — saves 50% on trains',
      'Swim in the Aare River in summer — a free local tradition',
    ],
  },
  {
    code: 'HEL',
    ...
    region: 'Europe',
    dailyCosts: {
      budget: { hotel: 30, food: 20, transport: 8, activities: 8 },
      mid: { hotel: 90, food: 40, transport: 14, activities: 20 },
      comfort: { hotel: 190, food: 75, transport: 22, activities: 40 },
    },
    currency: 'EUR',
    bestMonths: [6, 7, 8, 9],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Visit Suomenlinna Fortress by public ferry (included in transit pass)',
      'Eat at university cafeterias (Unicafe) for $3-5 lunches',
      'Walk the Design District and harbor area for free',
      'Use a day ticket for unlimited tram/bus/metro rides for about $9',
    ],
  },
  {
    code: 'KEF',
    ...
    region: 'Europe',
    dailyCosts: {
      budget: { hotel: 40, food: 30, transport: 12, activities: 15 },
      mid: { hotel: 120, food: 55, transport: 25, activities: 40 },
      comfort: { hotel: 280, food: 100, transport: 40, activities: 70 },
    },
    currency: 'ISK',
    bestMonths: [6, 7, 8],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Cook your own meals — groceries at Bonus supermarket are half the price of eating out',
      'Skip the Blue Lagoon ($80+) and visit free hot springs like Seljavallalaug',
      'Rent a car and split costs — buses are expensive and infrequent outside Reykjavik',
      'Visit in shoulder season (May/September) for lower prices and fewer crowds',
    ],
  },
  ...
  // ========== MIDDLE EAST (additional) ==========
  {
    ...
    region: 'Middle East',
    dailyCosts: {
      budget: { hotel: 25, food: 12, transport: 5, activities: 6 },
      mid: { hotel: 70, food: 30, transport: 12, activities: 18 },
      comfort: { hotel: 160, food: 60, transport: 22, activities: 40 },
    },
    currency: 'BHD',
    bestMonths: [11, 12, 1, 2, 3],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA'],
    savingTips: [
      'Eat at local cafeterias and shawarma shops for $2-4 per meal',
      'Visit the Bahrain National Museum (free entry) and walk the Bab al-Bahrain souk',
      'Take shared taxis or the public bus for $0.50-1 per ride',
      'Stay in Juffair or Adliya for cheaper hotels near restaurants and nightlife',
    ],
  },
  {
    code: 'KWI',
    ...
    region: 'Middle East',
    dailyCosts: {
      budget: { hotel: 30, food: 12, transport: 5, activities: 5 },
      mid: { hotel: 80, food: 30, transport: 12, activities: 15 },
      comfort: { hotel: 180, food: 60, transport: 22, activities: 35 },
    },
    currency: 'KWD',
    bestMonths: [11, 12, 1, 2, 3],
    visaFreeFor: ['US', 'UK', 'EU'],
    savingTips: [
      'Eat at local restaurants and Indian/Filipino eateries for $3-5 per meal',
      'Visit the free Kuwait Towers observation deck and Grand Mosque',
      'Use the public bus system — very cheap at $0.50 per ride',
      'Shop at the Mubarakiya Souk for local goods and cheap street food',
    ],
  },
  {
    code: 'RUH',
    ...
    region: 'Middle East',
    dailyCosts: {
      budget: { hotel: 25, food: 10, transport: 5, activities: 5 },
      mid: { hotel: 75, food: 28, transport: 12, activities: 18 },
      comfort: { hotel: 180, food: 55, transport: 22, activities: 40 },
    },
    currency: 'SAR',
    bestMonths: [11, 12, 1, 2, 3],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Eat at local shawarma and biryani joints for $2-4 per meal',
      'Visit the free Diriyah UNESCO site and National Museum ($3 entry)',
      'Use the new Riyadh Metro system for cheap transport',
      'Stay near Olaya Street for walkable access to malls and restaurants',
    ],
  },
  {
    code: 'MED',
    ...
    region: 'Middle East',
    dailyCosts: {
      budget: { hotel: 20, food: 8, transport: 4, activities: 3 },
      mid: { hotel: 60, food: 22, transport: 10, activities: 12 },
      comfort: { hotel: 140, food: 45, transport: 18, activities: 30 },
    },
    currency: 'SAR',
    bestMonths: [10, 11, 12, 1, 2, 3],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Stay slightly away from the Haram area for much lower hotel prices',
      'Eat at local restaurants near the old bazaar for $2-5 per meal',
      'Visit the Prophet Mosque (free) and walk to Mount Uhud',
      'Book during non-Hajj/Umrah season for lowest accommodation rates',
    ],
  },
  {
    code: 'BEY',
    ...
    dailyCosts: {
      budget: { hotel: 15, food: 8, transport: 3, activities: 5 },
      mid: { hotel: 50, food: 22, transport: 8, activities: 15 },
      comfort: { hotel: 120, food: 50, transport: 15, activities: 35 },
    },
    currency: 'LBP',
    bestMonths: [4, 5, 6, 9, 10, 11],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Eat manoushe, falafel, and shawarma from street vendors for $1-3',
      'Walk the Corniche, Gemmayzeh, and Mar Mikhael neighborhoods for free',
      'Take service taxis (shared) for $1-2 instead of private rides',
      'Visit the National Museum ($1 entry) and free Roman ruins in downtown',
    ],
  },
  ...
  // ========== EAST ASIA (additional) ==========
  {
    ...
    region: 'East Asia',
    dailyCosts: {
      budget: { hotel: 25, food: 10, transport: 3, activities: 5 },
      mid: { hotel: 70, food: 25, transport: 8, activities: 15 },
      comfort: { hotel: 180, food: 55, transport: 15, activities: 35 },
    },
    currency: 'MOP',
    bestMonths: [10, 11, 12, 3, 4],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Take the free casino shuttles to get around the Cotai Strip',
      'Eat at local cha chaan tengs and noodle shops for $3-5',
      'Walk the UNESCO Historic Centre of Macau — Ruins of St. Paul and Senado Square',
      'Stay on the peninsula side for cheaper hotels than Cotai resorts',
    ],
  },
  {
    code: 'CEB',
    ...
    region: 'Southeast Asia',
    dailyCosts: {
      budget: { hotel: 10, food: 5, transport: 3, activities: 8 },
      mid: { hotel: 35, food: 15, transport: 8, activities: 18 },
      comfort: { hotel: 90, food: 35, transport: 15, activities: 35 },
    },
    currency: 'PHP',
    bestMonths: [1, 2, 3, 4, 5, 12],
    visaFreeFor: ['US', 'UK', 'EU', 'AU', 'CA', 'JP', 'KR'],
    savingTips: [
      'Eat at local carinderias (food stalls) for $1-2 per meal',
      'Take jeepneys around the city for $0.20 per ride',
      'Island hop from Moalboal and Oslob on shared boats for $5-10',
      'Stay in Cebu City for cheap accommodation and day-trip to beaches',
    ],
  },
  ...
  // ========== SOUTH ASIA (additional) ==========
  {
    ...
    dailyCosts: {
      budget: { hotel: 8, food: 4, transport: 2, activities: 3 },
      mid: { hotel: 30, food: 12, transport: 5, activities: 8 },
      comfort: { hotel: 75, food: 30, transport: 12, activities: 20 },
    },
    currency: 'PKR',
    bestMonths: [3, 4, 5, 10, 11],
    visaFreeFor: [],
    savingTips: [
      'Eat at local dhabas for $1-2 — try nihari, biryani, and chapli kebab',
      'Visit the Faisal Mosque and Margalla Hills trails for free',
      'Take the Metro Bus for $0.30 per ride',
      'Apply for an e-visa in advance — available for many nationalities',
    ],
  },
]
...
const SEASONAL_PATTERNS: Record<string, SeasonalPattern> = {
  ...
  // Pacific Islands — peak = dry season (southern winter)
  'Pacific Islands': { peak: [7, 8, 9], low: [1, 2, 3], peakMultiplier: 1.35 },
  // Central Asia — peak = spring/autumn (mild), low = harsh winter
  'Central Asia': { peak: [5, 6, 9, 10], low: [12, 1, 2] },
  // Caucasus — peak = summer, low = winter
  'Caucasus': { peak: [6, 7, 8, 9], low: [12, 1, 2] },
}
