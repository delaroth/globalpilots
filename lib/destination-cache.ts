...
const TOP_ATTRACTIONS: Record<string, string[]> = {
  ...
  // Extended coverage
  KBV: ['Railay Beach', 'Tiger Cave Temple', 'Four Islands Tour'],
  ZNZ: ['Stone Town', 'Spice Tour', 'Prison Island'],
  DAR: ['Mikumi National Park', 'Coco Beach', 'National Museum'],
  ADD: ['Holy Trinity Cathedral', 'National Museum', 'Merkato Market'],
  ACC: ['Kwame Nkrumah Memorial', 'Makola Market', 'Cape Coast Castle'],
  TUN: ['Medina of Tunis', 'Carthage Ruins', 'Bardo Museum'],
  DKR: ['Goree Island', 'African Renaissance Monument', 'Ngor Island'],
  KGL: ['Genocide Memorial', 'Nyungwe Forest', 'Lake Kivu'],
  SCL: ['San Cristobal Hill', 'La Moneda', 'Central Market'],
  UIO: ['Old Town', 'Teleferico', 'Mitad del Mundo'],
  CUZ: ['Sacsayhuaman', 'San Pedro Market', 'Rainbow Mountain'],
  CTG: ['Old Walled City', 'Rosario Islands', 'Castillo San Felipe'],
  MVD: ['Mercado del Puerto', 'Ciudad Vieja', 'Rambla promenade'],
  TAS: ['Chorsu Bazaar', 'Khast Imam Complex', 'Amir Timur Museum'],
  ALA: ['Medeu Skating Rink', 'Big Almaty Lake', 'Green Bazaar'],
  GYD: ['Old City (Icherisheher)', 'Flame Towers', 'Highland Park'],
  FRU: ['Ala-Too Square', 'Osh Bazaar', 'Burana Tower'],
  NAN: ['Garden of the Sleeping Giant', 'Sigatoka Sand Dunes', 'Cloud 9'],
  TIA: ['Skanderbeg Square', 'Bunk Art', 'Grand Park'],
  SJJ: ['Bascarsija', 'Latin Bridge', 'Tunnel of Hope'],
  BEG: ['Kalemegdan Fortress', 'Knez Mihailova', 'Temple of St. Sava'],
  DBV: ['Old Town Walls', 'Lokrum Island', 'Stradun'],
  OPO: ['Livraria Lello', 'Dom Luis Bridge', 'Ribeira District'],
  HEL: ['Suomenlinna Fortress', 'Helsinki Cathedral', 'Market Square'],
  RIX: ['Old Riga', 'Art Nouveau District', 'Central Market'],
  VNO: ['Gediminas Tower', 'Uzupis', 'Gate of Dawn'],
  TLL: ['Old Town', 'Kadriorg Palace', 'Telliskivi Creative City'],
  BEY: ['Pigeon Rocks', 'National Museum', 'Hamra neighborhood'],
  CEB: ['Kawasan Falls', 'Oslob Whale Sharks', 'Magellan Cross'],
  LPQ: ['Kuang Si Falls', 'Night Market', 'Royal Palace Museum'],
  VTE: ['Pha That Luang', 'Buddha Park', 'Patuxai Monument'],
  DAC: ['Lalbagh Fort', 'Ahsan Manzil', 'Sadarghat River Terminal'],
}
...
const LOCAL_FOOD: Record<string, string[]> = {
  ...
  // Extended coverage
  KBV: ['Pad Thai', 'Green Curry', 'Fresh Grilled Fish'],
  ZNZ: ['Zanzibar Pizza', 'Urojo (soup)', 'Seafood Pilau'],
  DAR: ['Chips Mayai', 'Nyama Choma', 'Mishkaki'],
  ADD: ['Injera with Wat', 'Kitfo (beef tartare)', 'Ethiopian Coffee'],
  ACC: ['Jollof Rice', 'Banku with Tilapia', 'Kelewele'],
  TUN: ['Brik', 'Couscous', 'Lablabi (chickpea soup)'],
  DKR: ['Thieboudienne', 'Yassa Chicken', 'Mafe'],
  KGL: ['Brochettes', 'Ugali', 'Ibihaza (plantains)'],
  SCL: ['Empanadas', 'Pastel de Choclo', 'Completo (hot dog)'],
  UIO: ['Ceviche', 'Llapingachos', 'Encebollado'],
  CUZ: ['Cuy (guinea pig)', 'Lomo Saltado', 'Chicha Morada'],
  CTG: ['Arepas de Huevo', 'Ceviche', 'Coconut Rice'],
  MVD: ['Asado', 'Chivito', 'Alfajores'],
  TAS: ['Plov (pilaf)', 'Shashlik', 'Samsa (pastry)'],
  ALA: ['Beshbarmak', 'Lagman', 'Manty (dumplings)'],
  GYD: ['Plov', 'Dushbara', 'Qutab (flatbread)'],
  FRU: ['Lagman', 'Beshbarmak', 'Ashlyam-fu'],
  NAN: ['Kokoda (ceviche)', 'Lovo feast', 'Cassava cake'],
  TIA: ['Byrek', 'Tave Kosi', 'Qofte'],
  SJJ: ['Cevapi', 'Burek', 'Bosanski Lonac'],
  BEG: ['Cevapi', 'Pljeskavica', 'Kajmak'],
  DBV: ['Black Risotto', 'Peka', 'Fresh Oysters'],
  OPO: ['Francesinha', 'Pastel de Nata', 'Port Wine'],
  HEL: ['Karjalanpiirakka', 'Salmon Soup', 'Korvapuusti'],
  RIX: ['Piragi', 'Grey Peas with Bacon', 'Black Bread'],
  VNO: ['Cepelinai', 'Saltibarsciai (cold beet soup)', 'Kibinai'],
  TLL: ['Verivorst (blood sausage)', 'Kama dessert', 'Rye bread'],
  BEY: ['Hummus', 'Kibbeh', 'Manoushe'],
  CEB: ['Lechon', 'Sinigang', 'Puso (hanging rice)'],
  LPQ: ['Laap', 'Khao Piak Sen', 'Jaew Bong'],
  VTE: ['Tam Mak Houng', 'Larb', 'Khao Jee (baguette)'],
  DAC: ['Biryani', 'Hilsa Fish', 'Fuchka'],
}
