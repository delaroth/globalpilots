    ...
    <span className={`relative inline-flex items-center ${className}`}>
      ...
      {show && (
        <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 z-50 pointer-events-none">
          <span className="block max-w-[250px] bg-slate-950/95 border border-white/10 backdrop-blur-sm rounded-lg px-3 py-2 text-xs text-white/70 shadow-lg whitespace-normal text-center">
